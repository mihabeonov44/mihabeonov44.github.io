...
$(document).ready(function(){
    ...
    $('.button_mini').each(function(i) {
        $(this).on('click', function() {
            ...
            // Для отправки выбранного названия товара в письме на почту.
            // Запоминаю в переменную текст из элемента .catalog-item__subtitle
            var text1 = $('.catalog-item__subtitle').eq(i).text();

            console.log('товар text1 = '+text1);
            
            // Вставляю значение text1 в input с id="id_descr"
		    // $(this).parent().next().find("input.class_descr").val(text1); 
		    // $(this).parents(".modal").find("input.class_descr").val(text1); 
            document.getElementById('id_descr').value = text1; 
    ...
    $('form').submit(function(e) {
        ...
        // Напием функцию-валидатор. Если наша форма не прошла валидацию при помощи нашего плагина, то в таком случае мы эту функцию просто прекратим. Т.е. этот код не дойдёт до отправки запроса на smart.php (sendmail_pulse.php)
        if (!$(this).valid()) {
            return;
        }
    ...
    // К уроку 3.25. Подключаю библиотеку wow.js Библиотека wow.js работает только в связке с библиотекой animate.css
    // Подключаем палгин библиотеки wow.js 
    new WOW().init();
