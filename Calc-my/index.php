...
<html lang="ru">
  ...
  <body>
		...
		<div class="container">
			...
			<form method='post' action='save_word_mds.php' >
			 <h1>Калькулятор ремонта</h1>

			 <?php 
				// $res_category = mysql_query("SELECT *FROM price_cat ORDER BY sort");
				$res_category = mysqli_query($dbcnx,"SELECT *FROM price_cat ORDER BY sort");
				...
				if(mysqli_num_rows($res_category)>0)
				{
					...
					// В цикле выводятся все категории работ. 
					do
					{
					?>
					<div class="panel panel-default category">
						<div class="panel-heading">
							...
							<h4 class="panel-title">
								...
								<span class="summa_category"></span></a>
						...
						<!-- При клике на ссылку <a href="#price_cat<?php echo $i;?>"> с видом работ - раскрываются выбранные виды работ  -->
						<div id="price_cat<?php echo $i;?>" class="panel-collapse collapse">
							<div class="">
								<?php 
									$res_item = mysqli_query($dbcnx,"SELECT *FROM price_item WHERE catid = '$category[id]'");
									if(mysqli_num_rows($res_item)>0)
									{
										...
										// В цикле выводятся все виды работ.
										do
										{
										...
										while($item = mysqli_fetch_array($res_item));
										?>
										</table>
										</div>
										<?
				...
				<div class="panel-body well well-sm">
					<div class="row">
						<div class="col-xs-12 col-md-6 ">
							<button class="btn btn-primary btn-sm" name="save_word">Сохранить в WORD документ</button>
						</div>
						<div class="col-xs-12 col-md-6">
